                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='row justify-content-left'>
                                ...
                                <div className='col-md-6' style={{marginLeft: '8px'}}>
                                    <button type='submit' className='btn btn-primary submit-button' onClick={handleSubmit}>{isLoading ? <ReactLoading type='spin' color='orange' height={25} width={25}/>:'Register'}</button>
                                </div>
                                <br/>
